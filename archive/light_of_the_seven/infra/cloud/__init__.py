...
class GeminiConfig:
    ...
    studio_project_url: Optional[str] = None
    ...
    def from_env(cls) -> "GeminiConfig":
        ...
        return cls(
            project_id=env.get(
                "GEMINI_PROJECT_ID", env.get("GOOGLE_CLOUD_PROJECT", "")
            ),
...
class GeminiResponse:
    ...
    def from_api_response(
        cls, response_data: Dict[str, Any], latency: float = 0.0
    ) -> "GeminiResponse":
...
def generate_content_sync(prompt: str, **kwargs) -> GeminiResponse:
