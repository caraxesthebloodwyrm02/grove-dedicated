...
class TestGeminiConfig:
    ...
    def test_config_validation_no_key(self):
...
class TestGeminiSettings:
    ...
    def test_settings_is_deployed(self):
...
class TestGeminiStudioClient:
    ...
    @pytest.mark.asyncio
    async def test_client_initialization(self, mock_client: GeminiStudioClient):
    ...
    @pytest.mark.asyncio
    async def test_client_context_manager(self, mock_config: GeminiConfig):
    ...
    async def test_generate_success(
        self, mock_config: GeminiConfig, mock_response_data: Dict[str, Any]
    ):
    ...
    @pytest.mark.asyncio
    async def test_generate_rate_limit_retry(self, mock_config: GeminiConfig):
    ...
    @pytest.mark.asyncio
    async def test_generate_auth_error_no_retry(self, mock_config: GeminiConfig):
    ...
    def test_health_check(self, mock_config: GeminiConfig):
...
class TestGeminiCloudClient:
    ...
    @pytest.mark.asyncio
    async def test_pending_deployment_mock(self):
    ...
    def test_gemini_response_from_api(self):
    ...
    def test_gemini_response_error(self):
...
class TestLiveAPI:
    ...
    @pytest.mark.asyncio
    async def test_live_generate(self, api_key: str):
    ...
    @pytest.mark.asyncio
    async def test_live_stream(self, api_key: str):
        """Test live streaming."""
        config = GeminiConfig(api_key=api_key, model=GeminiModel.GEMINI_1_5_FLASH.value)
