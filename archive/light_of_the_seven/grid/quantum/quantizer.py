...
class QuantizedState(BaseModel):
    ...
    parent_state_id: Optional[str] = Field(default=None, description="Parent state ID")
...
class Quantizer:
    ...
    def quantize_value(self, value: float, level: Optional[QuantizationLevel] = None) -> float:
    ...
    def quantize_dict(
        self, data: Dict[str, Any], level: Optional[QuantizationLevel] = None
    ) -> Dict[str, Any]:
        ...
        for key, value in data.items():
            if isinstance(value, (int, float)):
                ...
                quantized[key] = [
                    self.quantize_value(v, level) if isinstance(v, (int, float)) else v
                    for v in value
                ]
            else:
                quantized[key] = value
    ...
    def get_step_size(self, level: Optional[QuantizationLevel] = None) -> float:
